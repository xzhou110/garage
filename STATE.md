...
- **Phase:** ✅ Built, verified, and **deployed to GitHub Pages** — live at https://xzhou110.github.io/garage/ (public repo `xzhou110/garage`, auto-deploy from `main` via Actions). Also runs locally (`cd app && npm run dev` → http://localhost:5178). 6 cars (c1–c6). Sheet URL verified absent from the public bundle.
- **Done:**
